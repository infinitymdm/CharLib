...
def test_noninverting_dff():
    ...
    output = Pin("Q", "output")
    inputs = [Pin("CLK", "input", role="clock", trigger=True), Pin("D", "input")]
...
def test_inverting_dffsr_with_active_low_sr():
    ...
    """
    output = Pin("QN", "output", is_inverted=True)
    inputs = [
        Pin("CLK", "input", role="clock", trigger=True),
        Pin("S", "input", role="set", is_inverted=True),
        Pin("R", "input", role="reset", is_inverted=True),
        Pin("D", "input"),
    ]
